// TODO should be available to share in core

// Need this for 'sql' global
import * as _ from '@backendPlugins';

// TODO should be in backendPlugins global definition

declare var sql_type: () => 'postgres' | 'sqlite';
